...
public class AlunoDAO {
    ...
    /**
     * Salva o registro de um aluno no banco de dados.
     * @param a objeto da classe Aluno, representando o aluno que será salvo no banco de dados
    ...
    /**
     * Exclui o registro do aluno com a dada matricula do banco de dados
     * @param matricula a matricula do registro do aluno que deverá ser excluído; 
     * @return true: se o registro foi excluido<br>
     * false: se o registro não pôde ser excluido.
     */
     ...
     * @param nome o nome ou parte do nome do(s) aluno(s) que se deseja(m) buscar.

...
public class EnderecoDAO {
     ...
     * um aluno.
     * 
     * @param e objeto da classe endereço, cujas informações serão registrados no 
     * banco de dados.
    ...
    public static int salvar(Endereco e) throws Exception {
         ...
         Connection conexao = FabricaDeConexoes.getConnection();
           ...
           String sql = "INSERT INTO endereco (cidade, bairro, rua, numero)"+
                    " VALUES (?, ?, ?, ?)";
     ...
     * 
     * @return o último código de endereço (o que tem o maior valor) 
     ...
     * @return true: se foi realizar a alteração.<br>

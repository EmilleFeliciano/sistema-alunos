...
public class TelaCadastrarAluno extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        comboBoxSerie.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...", "1 série", "2 série", "3 série" }));
        ...
        comboBoxSituacao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "...", "Aprovado", "Reprovado", "Recuperação", "Em processo" }));
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        try{
             int codEndereco =
        EnderecoControle.cadastrar(txtCidade.getText()
                ,txtBairro.getText(),
                 txtRua.getText(),
             ...
             if (codEndereco != 0){
                 ...
                 if(cadastrou) {
                     ...
                     JOptionPane.showMessageDialog(this, "Verifique seus dados pessoais.");
                 }
             }else{
